...
> 1. Periodically trying to update enddatetime value for "call" and "vxmlsession" tables because it’s presented in source tables with NULL value for incompleted calls (we may have a call lasting up to an hour)
